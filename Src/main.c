...
static void MX_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(PWR_BTN_GPIO_Port, PWR_BTN_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 | GPIO_PIN_5 | GPIO_PIN_7 | GPIO_PIN_9 | GPIO_PIN_10;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
